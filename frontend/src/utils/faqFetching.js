...
import { FAQUrl, typeStudent, typeAdmin, typeFaculty, fetchStudentFAQsUrl, fetchFacultyFAQsUrl, fetchAdminFAQsUrl } from '../resources/constants'
...
export const handleAdd = async (type, newQuestion, newAnswer, setNewQuestion, setNewAnswer, setFAQs, setLoading, setError) => {
  ...
  try {
    ...
    switch (type) {
      case typeStudent:
        newFAQsData = await getDataFrom(fetchStudentFAQsUrl)
        break
      case typeFaculty:
        newFAQsData = await getDataFrom(fetchFacultyFAQsUrl)
        break
      case typeAdmin:
        newFAQsData = await getDataFrom(fetchAdminFAQsUrl)
        break
      default:
        break
    }
