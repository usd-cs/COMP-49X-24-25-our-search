...
public class GatewayControllerTest {
    ...
    void setUp() {
        ...
        MajorProto major = MajorProto.newBuilder().setMajorId(1).setMajorName("Computer Science").build();
        ...
        DisciplineProto discipline = DisciplineProto.newBuilder().setDisciplineId(1).setDisciplineName("Engineering")
                .build();

        DisciplineWithMajors disciplineWithMajorsAndProjects = DisciplineWithMajors.newBuilder()
                .setDiscipline(discipline)
                .addMajors(majorWithProjects)
                .build();

        DisciplineWithMajors disciplineWithMajorsAndStudents = DisciplineWithMajors.newBuilder()
                .setDiscipline(discipline)
    ...
    void getCurrentProfile_returnsExpectedResult() throws Exception {
        ...
        ProfileResponse profileResponse = ProfileResponse.newBuilder()
                .setRetrieveProfileResponse(retrieveProfileResponse).build();

        ModuleResponse moduleResponse = ModuleResponse.newBuilder().setProfileResponse(profileResponse).build();
    ...
    void editStudentProfile_returnsExpectedResult() throws Exception {
        ...
        EditProfileResponse editProfileResponse = EditProfileResponse.newBuilder().setSuccess(true)
                .setEditedStudent(editedStudent).build();
    ...
    void editFacultyProfile_returnsExpectedResult() throws Exception {
        FacultyProto editedFaculty = FacultyProto.newBuilder()
                .setFirstName("UpdatedFirst")
                .setLastName("UpdatedLast")
                .setEmail("faculty@test.com")
        ...
        EditProfileResponse editProfileResponse = EditProfileResponse.newBuilder().setSuccess(true)
                .setEditedFaculty(editedFaculty).build();
    ...
    void deleteCurrentProfile_returnsExpectedResult() throws Exception {
        DeleteProfileResponse deleteProfileResponse = DeleteProfileResponse.newBuilder().setSuccess(true).build();
    ...
    void getFacultyProfile_returnsExpectedResult() throws Exception {
        ...
        FacultyProfile facultyProfile = FacultyProfile.newBuilder().setFaculty(facultyProto).addProjects(projectProto)
                .build();
    ...
    void createProject_returnsExpectedResult() throws Exception {
        ProjectProto createdProject = ProjectProto.newBuilder()
                .setProjectId(1)
        ...
        CreateProjectResponse createProjectResponse = CreateProjectResponse.newBuilder()
                .setSuccess(true)
                .setProjectId(1)
    ...
    void getAllFaculty_returnsExpectedResult() throws Exception {
        DepartmentProto engineeringProto = DepartmentProto.newBuilder().setDepartmentId(1)
        ...
        FacultyWithProjects facultyWithProjects = FacultyWithProjects.newBuilder().setFaculty(facultyProto)
                .addProjects(projectProto).build();

        DepartmentWithFaculty departmentWithFaculty = DepartmentWithFaculty.newBuilder()
                .setDepartment(engineeringProto)
                .addFacultyWithProjects(facultyWithProjects)
                .build();

        DepartmentHierarchy departmentHierarchy = DepartmentHierarchy.newBuilder().addDepartments(departmentWithFaculty)
                .build();

        FetcherResponse fetcherResponse = FetcherResponse.newBuilder().setDepartmentHierarchy(departmentHierarchy)
                .build();

        ModuleResponse moduleResponse = ModuleResponse.newBuilder().setFetcherResponse(fetcherResponse).build();
    ...
    void deleteProject_success_returnsOk() throws Exception {
        ...
        DeleteProjectResponse deleteProjectResponse = DeleteProjectResponse.newBuilder().setSuccess(true).build();
    ...
    void editProject_returnsExpectedResult() throws Exception {
        ProjectProto editedProject = ProjectProto.newBuilder()
                .setProjectId(1)
        ...
        EditProjectResponse editProjectResponse = EditProjectResponse.newBuilder()
                .setSuccess(true)
                .setProjectId(1)
